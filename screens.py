...
class Lcd_Screens:
	...
	def setpoint(self):
		...
		self.lcd.move_to(0, 2)
		self.lcd.putstr('Angulo: 000')
		self.lcd.move_to(0, 3)
		self.lcd.putstr('Erro:   000')
	...
	@mestre
	def tensao_baixa(self):
		self.lcd.custom_char(0, bytearray([0x0E,0x00,0x0E,0x01,0x0F,0x11,0x0F,0x00]))
		self.lcd.custom_char(1, bytearray([0x00,0x00,0x00,0x04,0x0E,0x1F,0x0E,0x0E]))
		self.lcd.custom_char(2, bytearray([ 0x00,0x00,0x04,0x0E,0x1F,0x0E,0x0E,0x00]))
		self.lcd.custom_char(3, bytearray([0x00,0x04,0x0E,0x1F,0x0E,0x0E,0x00,0x00]))
		self.lcd.move_to(1,0)
		self.lcd.putstr("Tensao muito baixa")
		self.lcd.move_to(1,1)
		self.lcd.putstr("Conecte uma fonte")
		self.lcd.move_to(8,2)
		self.lcd.putstr("12V")
		while True:
			self.lcd.move_to(0,3)
	...
	@mestre
	def tensao_alta(self):
		self.lcd.custom_char(0, bytearray([0x0E,0x00,0x0E,0x01,0x0F,0x11,0x0F,0x00]))
		self.lcd.custom_char(1, bytearray([0x0E,0x11,0x1B,0x15,0x1B,0x0E,0x00,0x00]))
		self.lcd.custom_char(2, bytearray([0x00,0x0E,0x11,0x1B,0x15,0x0A,0x0E,0x00]))
		self.lcd.custom_char(3, bytearray([0x00,0x00,0x0E,0x11,0x1B,0x15,0x0A,0x0E]))
		self.lcd.move_to(1,0)
		self.lcd.putstr("Tensao muito alta")
		self.lcd.move_to(1,1)
		self.lcd.putstr("Conecte uma fonte")
		self.lcd.move_to(8,2)
		self.lcd.putstr("12V")
